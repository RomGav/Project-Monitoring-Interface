    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white shadow rounded-lg">
            <div className="flex justify-between items-center mb-6">
                ...
                <h2 className="text-2xl font-bold">New Project Manager:</h2>
            </div>

            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className={formGroup}>
                    <label className={labelClass}>Project Manager ID:</label>
                    <input type="number" name='projectManagerId' value={form.projectManagerId} onChange={handleChange} className={inputClass}/>
                </div>
                <div className={formGroup}>
                ...
                <div className="md:col-span-2 flex justify-end">
                    <button className={buttonClass}>Create New Project Manager</button>
                </div>
            </form>
        </div>
    );
